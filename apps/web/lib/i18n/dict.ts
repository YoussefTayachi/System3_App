...
const de = {
  ...
  aiAgent: {
    ...
    templateSubtitle: "Startpunkt für den System-Prompt, danach frei editierbar.",
    templates: [
      { id: "default", label: "Standard", hint: "Scharfe, faktenbasierte Beobachtung ohne festen Winkel." },
      { id: "pain_point", label: "Pain-Point-Fokus", hint: "Spricht einen wahrscheinlichen Engpass direkt an, gut für Cold Calls." },
      { id: "needs", label: "Bedarfs-Fokus", hint: "Benennt, was das Unternehmen als Nächstes wahrscheinlich braucht." },
    ],
    customTemplateLabel: "Eigene Vorlage",
...
const en: Dictionary = {
  ...
  aiAgent: {
    ...
    templateSubtitle: "Starting point for the system prompt, fully editable afterwards.",
    templates: [
      { id: "default", label: "Default", hint: "Sharp, fact-based observation with no fixed angle." },
      { id: "pain_point", label: "Pain point focus", hint: "Directly names a likely bottleneck, good for cold calls." },
      { id: "needs", label: "Needs focus", hint: "States what the company likely needs next." },
    ],
